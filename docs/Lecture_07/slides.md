...
1) **Classification, Measurement and Validation**
2) **From Qualitative to Quantitative text analysis**
3) **Different classification strategies**
4) **Different types of quantitative analysis**
...
![bg right contain](images/image-11.png)
...
#### Recap: Qualitative analysis divided into different focuses areas
...
### Establishing ground truth through **qualified** closed coding
...
2) Externalizes implicit conceptions and knowledge

3) Analysis mode: valid, fair, reliable, and effective


<img src="images/image-4.png" alt="drawing" width="600" class="center"/>
...
<img src="images/image-1.png" alt="drawing" width="800" class="center"/>
